...
((function ( $ ) {
  ...
  $.widget('aerolab.blockrain', {
    ...
    options: {
      ...
      // Copy
      playText: 'Let\'s play some Block Breaker',
      playButtonText: 'Press Start!',
      gameOverText: 'Final Score',
      restartButtonText: 'Press Start to play again!',
      scoreText: 'Score',
    ...
    start: function() {
      ...
      setTimeout(function(){window.gameOver = true;}, 60 * 1000) //modify to modify timer
    },
      ...
      game._$gameover = $(
        '<div class="blockrain-game-over-holder" style="position:absolute;">'+
          '<div class="blockrain-game-over">'+
            '<div id="finalScore" class="blockrain-game-over-msg">'+ this.options.gameOverText +' </div>'+
